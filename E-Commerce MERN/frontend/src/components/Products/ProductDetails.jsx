...
// Hardcoded product data as fallback
...
const ProductDetails = () => {
  ...
  // Use hardcoded product if no selected product from Redux
  const product = selectedProduct || hardcodedProduct;
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      toast.error(error.message || "Failed to add to cart", { duration: 1000 });
    } finally {
